...
const expectedStandard = {
  ...
  days: {
    ...
    tuesday: { sheets: [
      sheet('finding-the-percent', 'math', 'Finding the Percent', 'Keep practicing the same method: write the fraction, simplify it, then name the percent. If the simplified fraction is not one of your benchmarks, think about what it would be out of 100.', '12 out of 20 = 12/20 = 3/5 = 60%. (3/5 is the same as 6/10, which is 60 out of 100.)', [percent('12-of-20', '12 out of 20 = ?', 60), percent('14-of-20', '14 out of 20 = ?', 70), percent('9-of-12', '9 out of 12 = ?', 75), percent('7-of-28', '7 out of 28 = ?', 25), percent('20-of-25', '20 out of 25 = ?', 80)]), codeQuest(),
    ] },
    wednesday: { sheets: [
      sheet('finding-the-percent', 'math', 'Finding the Percent', 'Here is another way to find the percent: figure out what you would need to multiply the bottom number by to reach 100, then multiply the top number by that same amount. That gives you the percent directly.', '17 out of 20 = 17/20. Since 20 × 5 = 100, multiply the top too: 17 × 5 = 85. So 85%.', [percent('17-of-20', '17 out of 20 = ?', 85), percent('11-of-20', '11 out of 20 = ?', 55), percent('22-of-25', '22 out of 25 = ?', 88), percent('6-of-24', '6 out of 24 = ?', 25)]), codeQuest(),
    ] },
    thursday: { sheets: [
      sheet('finding-the-percent', 'math', 'Finding the Percent', 'This is exactly how test scores, sports stats, and surveys get turned into percents in real life. Use the same method: fraction first, then simplify to find the percent.', 'Basketball: 15 out of 20 free throws made. 15/20 = 3/4 = 75%.', [percent('test', '27 out of 30 on a test = ?', 90), percent('basketball', 'Basketball: 15 out of 20 free throws made = ?', 75), percent('survey', 'Survey: 40 out of 50 students prefer pizza = ?', 80), percent('spelling', 'Spelling: 17 out of 20 correct = ?', 85)]),
      sheet('word-problems', 'word-problems', 'Word Problems', 'Same method as Math, applied to real situations. Write the fraction, simplify, then name the percent.', 'Video game: beat 45 out of 50 levels. 45/50 = 9/10 = 90%.', [percent('video-game', 'Video game: beat 45 out of 50 levels. What percent?', 90), percent('summer', 'Survey of 40 kids: 32 like summer best. What percent?', 80), numeric('free-throws', 'Free throws in practice: 14 out of 16 made. What percent?', 87.5)]),
    ] },
    friday: { sheets: [
      sheet('finding-the-percent', 'math', 'Finding the Percent', "Some of these ask you to find a percent OF a number (your old skill). Others ask what percent one number IS of another (your new skill this week). Read each one carefully before you start.\n\nMixed review: some ask 'what percent is A of B,' others ask 'what is X% of a number.' Read carefully to see which direction each question goes.", null, [percent('15-of-20', 'What percent is 15 out of 20?', 75), percent('25-percent-of-60', '25% of 60 = ?', 15), percent('9-of-12', 'What percent is 9 out of 12?', 75), percent('90-percent-of-40', '90% of 40 = ?', 36), percent('6-of-8', 'What percent is 6 out of 8?', 75)]),
      sheet('word-problems', 'word-problems', 'Word Problems', 'Work through each one using the fraction method you practiced all week. Show your fraction before you write the final percent.\n\nShow What You Know! Try these on your own.', null, [percent('big-test', 'You get 42 out of 50 on a big test. What percent?', 84), percent('soccer', 'Your soccer team wins 9 out of 12 games. What percent?', 75)]),
    ] },
  },
};
