...
export default [
  P(1, 'Phase 1 — AI Security Operator', {
    ...
    links: [
      ...
      { name: 'Google AI Professional Certificate', by: 'Google (grow.google / Coursera)', url: 'https://grow.google/ai-professional/', hours: 8, note: '$49/mo Coursera, 8 courses ~1hr each (~8hrs). Free for eligible US small businesses (<=500 employees) via grow.google/small-business — Kairos Authority likely qualifies, check before paying. Bonus either way: 3 months free Google AI Pro (~$147 value).', quiz: [
        { q: 'The certificate includes 3 months of Google AI Pro free. What does that bonus actually save you if you\'d otherwise pay for it?', choices: ['Nothing, Google AI Pro is always free', 'About $147 — Google AI Pro normally runs ~$49/month', 'A one-time $10 discount', 'Free cloud storage only, no AI tools'], answer: 1, why: 'At ~$49/mo, 3 months free is roughly $147 of value on top of the certificate itself — worth confirming you actually redeem it, not just the course completion.' },
      ] },
